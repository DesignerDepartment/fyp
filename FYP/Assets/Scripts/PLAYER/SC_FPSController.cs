...
public class SC_FPSController : MonoBehaviour
{
	...
	void Update()
	{
		...
		if (Input.GetButton("Fire2"))
		{
			...
			if (nakAmbil == true)
			{
				//if bilasSabun true (execute cedokAirBilasSabun)
				//else (execute cedokAir)

				if (arrowBilasAirSabun.activeSelf == true)
				{
					cedokAirBilasSabun();
					nakAmbil = false;
				}
